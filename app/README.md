...
> **Note:** At minimum you need one LLM provider key (OpenAI or Groq) to run the agents.
...
For more details on the agents and trading system, see the [main README](../README.md).
...
- **Port already in use**: Kill any existing processes on ports 5173 or 8000 before starting.
- **Poetry not found**: Make sure Poetry is installed and added to your PATH.
